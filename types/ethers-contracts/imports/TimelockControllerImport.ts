...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface TimelockControllerImportInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'updateDelay', data: BytesLike): Result;
  ...
  export interface TimelockControllerImport extends BaseContract {
    
    connect(runner?: ContractRunner | null): TimelockControllerImport;
    waitForDeployment(): Promise<this>;

    interface: TimelockControllerImportInterface;
